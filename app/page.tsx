  ...
  return (
    <main>
      ...
      <div className="badge-bar">
        ...
        <a href="/ueber-uns" className="badge-item">
          <RatingBadge
            title="Meisterbetrieb Wien"
            subtitle="Inhabergeführt & Kompetent"
            rating={5}
          />
        </a>
            ...
            {LEISTUNGEN.slice(0, 9).map((l) => (
              <a key={l.slug} href={`/leistungen/${l.slug}`} className="service-magic-card">
                <div className="service-card__inner">
                  <div className="service-card__img-container" style={{ position: 'relative', height: '240px' }}>
                    <Image
                      src={l.image}
                      alt={l.title}
                      fill
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '60px', alignItems: 'center', marginBottom: '48px' }} className="about-grid">
            ...
            <div style={{ position: 'relative', height: '420px', width: '100%' }}>
              <Image
                ...
                fill
                style={{ borderRadius: '16px', objectFit: 'cover', boxShadow: '0 20px 60px rgba(0,0,0,0.12)' }}
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px' }} className="feature-cards-grid">
            {[
              ...
              <div key={card.title} style={{
                ...
                display: 'flex', flexDirection: 'column', gap: '6px', boxShadow: '0 2px 8px rgba(0,0,0,0.04)',
              }}>
      ...
      <section style={{ background: 'var(--primary)', padding: '72px 0' }}>
        <div className="container" style={{ textAlign: 'center' }}>
          <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '13px', fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase', marginBottom: '16px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '60px', alignItems: 'center' }} className="dienst-grid">
            <div style={{ position: 'relative', height: '460px' }}>
              <Image
                ...
                fill
                style={{ borderRadius: '16px', objectFit: 'cover', boxShadow: '0 16px 48px rgba(0,0,0,0.10)' }}
                sizes="(max-width: 991px) 100vw, 50vw"
              />
            </div>
            <div>
            ...
            <div>
              <div style={{ position: 'relative', height: '460px', width: '100%' }}>
                <Image
                  ...
                  fill
                  style={{ borderRadius: '16px', objectFit: 'cover', boxShadow: '0 20px 60px rgba(0,0,0,0.1)' }}
                  sizes="(max-width: 991px) 100vw, 50vw"
                />
              </div>
        ...
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '60px', alignItems: 'center' }} className="ebefund-grid">
            ...
            <div>
              ...
              <h2 style={{ marginBottom: '16px' }}>Verlässliche Sicherheit durch den E-Befund (E-Check)</h2>
              <p style={{ color: 'var(--mid)', marginBottom: '20px' }}>
                Ein gültiger E-Befund ist für Vermieter, Hausverwaltungen und Gewerbetreibende gesetzlich vorgeschrieben (ETV 2020 / MRG).
                Elektro-Bozogul erstellt rechtssichere E-Befunde schnell und zuverlässig in ganz Wien.
              </p>
              <ul style={{ listStyle: 'none', padding: 0, marginBottom: '28px', display: 'flex', flexDirection: 'column', gap: '10px' }}>
                {['Prüfprotokoll nach ÖVE/ÖNORM E 8101', 'Rechtssicher für Vermieter & Hausverwaltungen', 'Schnelle Terminvergabe in ganz Wien'].map((item) => (
              ...
              <a href="/leistungen/e-befund-wien" className="btn-sparkle">
                <span className="text_button" style={{ padding: '12px 24px' }}>Mehr zum E-Befund →</span>
              </a>
            </div>
          </div>
        </div>
      ...
      <section className="section" style={{ background: 'var(--white)', paddingTop: '80px', paddingBottom: '80px' }}>
        <div className="container">
          ...
          <div style={{ position: 'relative', borderRadius: '20px', overflow: 'hidden', height: '300px' }}>
            ...
            <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px', zIndex: 10 }}>
              <div style={{ background: 'white', padding: '16px 32px', borderRadius: '20px', textAlign: 'center' }}>
